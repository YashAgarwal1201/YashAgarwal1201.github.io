  ...
  return (
    <div className="relative">
      <Dialog
        ...
        header={
          <>
            <div className="text-color1 font-heading font-normal">Please fill out this form</div>
          </>
        }
        ...
        >
          <div className="flex flex-col md:flex-row gap-x-3 gap-y-3">
            <div className="w-full md:w-1/2 flex flex-col gap-y-3">
              <label className="text-lg font-heading">Your Email Address:</label>

              <input
                title="Email address"
                className="h-10 px-4 bg-color3 text-color1 rounded-lg font-content"
                type="email"
                name="Email"
                required
              />
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-y-3">
              <label className="text-lg font-heading">Your Name:</label>

              <input
                title="Name"
                className="h-10 px-4 bg-color3 text-color1 rounded-md font-content"
                type="text"
                name="Name"
              />
            </div>
          ...
          <div className="w-full flex flex-col gap-y-3">
            <label className="text-lg font-heading">Your Message:</label>

            <textarea
              title="You message"
              className="h-40 p-4 bg-color3 text-color1 font-content rounded-lg resize-none"
              name="Msg"
              required
            ></textarea>
          </div>
          <div className="w-full h-12 flex flex-row-reverse justify-center items-center gap-x-4 font-content">
            <Button
              title="click to send"
